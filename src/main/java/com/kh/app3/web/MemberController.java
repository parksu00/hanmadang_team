...
public class MemberController {
  ...
  public String add(@Valid @ModelAttribute AddForm addForm,
    ...
    //닉네임 중복체크
    Boolean isExistNickName = memberSVC.dupChkOfMemberNickname(addForm.getNickname());
    if(isExistNickName){
...
//    redirectAttributes.addAttribute("member_id",member_id);
    ...
    return "redirect:/members/login"; //회원 상세
  }
...
//    log.info("id={}, password={}, isExist={}",loginMember.getId(), passwordForm.getPassword(), isExistPassword);
    ...
    return "member/my_info_update";  //회원정보 수정화면 이동
  }
  ...
  public String updateInfoPost(@Valid @ModelAttribute EditForm editForm,
                               BindingResult bindingResult,
